 ...
 */
final class Version20201217091312 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE film ADD genre_id INT, ADD affiche LONGTEXT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE film DROP genre_id, DROP affiche');
    }
}
